# Generated by Django 3.0.5 on 2022-04-06 17:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(max_length=300, verbose_name='display_name')),
                ('id', models.CharField(max_length=300, verbose_name='id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guests', models.ManyToManyField(to='api.Listener')),
                ('sync', models.ManyToManyField(blank=True, to='api.Sync')),
            ],
            options={
                'verbose_name': 'room',
